...
function valuesFromSpecies(species: Species): Partial<FormData> {
  return {
...
export default function EditSpeciesDialog({ species }: { species: Species }) {
  ...
  const defaultValues: Partial<FormData> = valuesFromSpecies(species);
  ...
  const onSubmit = async (input: FormData) => {
    ...
    // Reset to the new values (useful if the user reopens the dialog)
    form.reset(valuesFromSpecies({ ...species, ...input } as Species));
                ...
                render={({ field }) => {
                  ...
                  return (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input value={value ?? ""} placeholder="https://example.org/image.jpg" {...rest} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  );
